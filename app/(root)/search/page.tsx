...
const sortOrders = ["newest", "lowest", "high", "rating"];
        ...
        <div>
          <ul className="space-y-1">
            ...
            {categories.map((x) => (
              <li key={x.category}>
                <Link
                  className={`${categories === x.ca && "font-bold"}`}
      ...
      <div className="md:col-span-4 space-y-4">
        <div className="flex-between flex-col my-4 md:flex-row">
          <div className="flex items-center">
            {q !== "all" && q !== "" && "query: " + q}
            {category !== "all" && category !== "" && "category: " + q}
